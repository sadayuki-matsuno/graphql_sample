...
var (
	userDBTypes = map[string]string{`CreatedAt`: `timestamp with time zone`, `DeletedAt`: `timestamp with time zone`, `Email`: `text`, `ID`: `integer`, `Name`: `text`, `Password`: `text`, `UpdatedAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
