...
var (
	userColumns               = []string{"id", "created_at", "updated_at", "deleted_at", "name", "email", "password"}
	userColumnsWithoutDefault = []string{"created_at", "updated_at", "deleted_at", "name", "email", "password"}
